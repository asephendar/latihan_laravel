    ...
    <div class="drawer lg:drawer-open flex-grow">
        ...
        <div class="drawer-side" x-data="{ active: window.location.pathname }">
            ...
            <ul class="menu bg-base-200 min-h-full w-64 p-4">
                <!-- Sidebar Menu -->
                <li :class="active === '/dashboard' ? 'bg-primary text-white' : ''">
                    <a href="/dashboards">
                ...
                <li :class="active === '/user' ? 'bg-primary text-white' : ''">
                    <a href="/users">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <li :class="active === '/sales_transactions' ? 'bg-primary text-white' : ''">
                    <a href="/sales_transactions">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="1.5" color="currentColor">
                                <path
